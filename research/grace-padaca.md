# Maria Gracia Cielo "Grace" Magno Padaca — In-Depth Research Dossier

**Compiled September 18, 2026 · For site-selection/political-context research (Region 2 - Info project)**
All claims carry reference tags `[R#]` resolving to the source list at the end. A cross-reference matrix (Section 13) flags which facts are confirmed by multiple independent sources and which rest on a single source or conflict between sources.
...
- **Full name:** Maria Gracia Cielo Magno Padaca. Filipino naming convention: middle name *Magno* (maternal), surname *Padaca* [R1].
- **Born:** October 25, 1963, in Cauayan, Isabela [R1]. (Conflict note: Bulatlat's May 2004 profile calls her "37-year-old," which would imply a 1966/67 birth year; the 1963 date is corroborated by both Wikipedia and the Ramon Magsaysay Award Foundation and is treated as authoritative. See Section 13.)
- **Parents:** Bernardo Padaca (DepEd district supervisor, d. 1984) and Amelia Magno (retired home-economics teacher) — both public school teachers [R3]. Six children: two brothers, three sisters [R3].
- **Disability:** Paralyzed by polio at age three; has walked on crutches for most of her life; was taunted as a child and retreated into books [R1][R2]. The Senate honored her as "a heroine ahead of our time" in 2008, explicitly citing her example for persons with disability [R5].
- **Class background:** describes her family as lower-middle-class; in 2004 claimed no property beyond a discount-bought TV set [R3].
- **Education:** Certified Public Accountant, Lyceum of the Philippines University, 1984, on scholarships [R1][R2][R5]. (Lyceum profiles her as an alumna trailblazer [R12].)

---

## 3. Broadcasting Career — "Bombo Grace" (1986–2000)
...
**Cross-reference:** the 48-vote HRET margin appears identically in the Magsaysay Foundation biography [R2] and Wikipedia [R1] (RMAF is the primary; Wikipedia cites it).

---

## 5. The 2004 Gubernatorial Victory

- Declared her candidacy February 2004 on her own radio program [R3].
...
## 6. Governorship (June 30, 2004 – June 30, 2010)

Party: won in 2004 under Aksyon Demokratiko; ran again in 2007 under the Liberal Party [R1].

### 6.1 Fiscal reform
- Overhauled provincial finances; **reduced provincial debt by two-thirds** and left budget surpluses by the end of her term [R1][R2 ("paid off two-thirds of the province's huge debts and restored its fiscal credibility")][R7].
- Neutralized early sabotage attempts by Dy loyalists in the provincial bureaucracy [R2].

### 6.2 Agriculture — Hybrid Rice Program
- Flagship program: hybrid rice with farmer-credit and reasonable borrowing terms; **10 Isabela towns became among the top hybrid-rice producers in Cagayan Valley** [R1].
- Price-support arrangement with the National Food Authority: **₱5/kilo subsidy** on NFA purchases of rice and corn from farmers [R1].
- (This is the same program that later became the subject of her criminal case — see Section 9. The ₱25M EDWINLFI facility was the credit side of it [R8].)

### 6.3 Health & social services
- Replaced a bankrupt medical scheme with a government-backed plan (PhilHealth expansion) [R2].
- Expanded PhilHealth coverage to ~**700,000** individuals; invested ~**₱98M** in premium payments; **doubled barangay health-worker allowances**; gave public attorneys a **₱2,000/month** allowance [R1][R7].

### 6.4 Environment — anti-illegal logging
- Reactivated the anti-illegal-logging task force; created a forest protection task force in 2006 for the **Northern Sierra Madre Natural Park** [R1].
- Peak enforcement: **~1.8 million board feet of confiscated timber worth ₱30M+ — described as the biggest illegal-timber haul in Philippine history** [R1][R9 (GMA iWitness documentary "Si GOB at ang mga BUGADOR")][R10 (GMA News)].
- ABS-CBN analysis at the time argued the anti-logging drive was a political liability with logging-linked constituencies going into 2010 [R16].

### 6.5 Good-governance movement
...
## 7. The 2007 Re-election and the Annulment Saga

- Won a second term in 2007 (Liberal Party) against former governor **Benjamin Dy**, with a lead of **17,007 votes** [R1].
- Dy petitioned Comelec for a recount of **683 ballot boxes from 12 towns**, alleging thousands of Padaca votes were written by a single individual [R1].
- **December 2009:** Comelec ruled Dy received 199,435 vs Padaca's 198,384 — a **1,051-vote reversal** — annulled her proclamation, and ordered Dy's inauguration [R1][R17 ("Comelec unseats Padaca")][R18 (ABS-CBN/Santos)].
- Padaca appealed (Comelec en banc / Supreme Court), **kept office, and served her full term to June 30, 2010** [R1]. (No source in this dossier documents a final ruling on that appeal — open question, Section 13.)

---

## 8. The 2010 Defeat

- Term-limited out of the arithmetic of her annulled seat, she ran again in 2010 and lost to returning congressman **Bojie Dy III by 3,438 votes** [R1][R19 (Manila Times archive)]. The Dy restoration thereby completed: province (Bojie III), Cauayan (Benjamin Dy), and eventually Congress and the Speakership (see region2-info Political tab timeline).

---

## 9. The Criminal Cases (EDWINLFI Rice Program)

### 9.1 The underlying transaction (2006)
- The province took a **₱35M loan from the Development Bank of the Philippines**; **₱25M** was released to the NGO **Economic Development for Western Isabela and Northern Luzon Foundation, Inc. (EDWINLFI)** as middleman/credit channel for the hybrid rice program [R8].
- Red flags found by the courts and Ombudsman:
  1. Padaca signed the MOA on **January 8, 2006**, before the Sangguniang Panlalawigan authorized NGO engagement on **January 31, 2006** — and the SP's resolution required the MOA's submission for review, which was not complied with [R8][R9a (Philstar)].
  2. **No public bidding** (RA 9184 issue; Sandiganbayan ultimately held bidding was not required for this non-procurement transaction — see 9.3) [R8][R9a].
  3. The provincial accountant flagged that EDWINLFI **never submitted SEC/financial statements** and that the MOA had **no repayment scheme**; she was overruled [R8].
...
The conviction rested on **negligence-based malversation** (allowing an NGO to hold ₱18M with no repayment scheme) rather than personal enrichment; the courts found no evidence of personal enrichment ("did not personally gain"), and the graft theory was ultimately rejected on appeal [R8][R9a][R23]. This distinction matters for anyone weighing the case politically: it is a public-funds-controls case, not a personal-enrichment case.

---

## 10. Comelec Commissioner (October 8, 2012 – 2014)

- Appointed by President **Benigno Aquino III** as Comelec commissioner [R1][R10 (Rappler)][R11 (GMA)].
- The **Commission on Appointments never confirmed** her — bypassed, reportedly due to the pending graft case — and she was **not reappointed after being bypassed in 2014** [R1][R25 (Inquirer — she blamed LP stalwart Mar Roxas for allying with her rivals while her appointment hung)].
- She served through the May 2013 midterms as commissioner.
...
| # | Fact | Sources confirming | Status |
|---|---|---|---|
| 1 | Born Oct 25, 1963, Cauayan; parents both teachers | R1 (Wikipedia), R3 (Bulatlat), R2 (RMAF, birth year only) | **Multi-source, consistent** |
| 2 | Birth year "37 years old" in Bulatlat (implies 1966/67) | R3 only | **Conflict** — R1/R2 say 1963; treat 1963 as authoritative, Bulatlat as likely error |
| 3 | Polio at 3; crutches lifelong | R1, R2, R5, R11 (GMA) | **Multi-source** |
| 4 | CPA, Lyceum, 1984 | R1, R2, R12 | **Multi-source** |
| 5 | Bombo Radyo 1986, 14 years, accountant→host→asm | R1, R2, R3 | **Multi-source** |
| 6 | 1995 anti-split campaign | R1 (citing Bulatlat warlordism piece), R3 | **Multi-source** (both trace to Bulatlat reporting — treat as same-journalism-family corroboration) |
| 7 | 2001 loss margin 1,285 → HRET 48 votes (Dec 18, 2003) | R1, R2 | **Multi-source** (R2 primary) |
| 8 | 2004 win: 55%, +44,292 vs Dy Jr. | R1, R2, R3 | **Multi-source** |
...
| 22 | Comelec commissioner Oct 8, 2012 – 2014, bypassed | R1, R10, R11, R25 | **Multi-source** |
| 23 | 2016 loss by 300K+; 2019 VG loss 483,392–166,972 | R1, R26 | **Multi-source** |
| 24 | Magpakailanman portrayal (Janice de Belen, 2004) | R1 only | **Single-source; low stakes, but unverified independently** |
| 25 | Bombo Radyo 2004 shutdown → SC ₱5M award (2010) | R14 (Philstar/SC) + region2-info Political tab | **Multi-source** (cross-links to Cauayan political history) |

**Standing verification gaps (would need primary documents):** Comelec en banc/SC disposition of her 2007 annulment appeal; any CA/SC ruling on the malversation conviction after 2020; the original Sandiganbayan decision text (G.R./docket searchable via elibrary.judiciary.gov.ph — the Ombudsman's 2011 resolution is at R20).
...
**Core biographical**
- R1. Wikipedia — "Grace Padaca" (consolidated biography + footnoted reference list): https://en.wikipedia.org/wiki/Grace_Padaca
...
- R7. PCIJ — "Isabela's non-dynasty detour" (2009): https://old.pcij.org/stories/isabelas-non-dynasty-detour/ (site intermittently unreachable; archived copies via Wayback)
- R9. GMA News — iWitness documentary "Si GOB at ang mga BUGADOR" (Aug 2008): http://www.gmanews.tv/video/27703/iWitness-Si-GOB-at-ang-mga-BUGADOR
- R16. ABS-CBN — "Padaca's drive vs logging may cost her the gubernatorial race" (May 2010): https://www.abs-cbn.com/-depth/05/08/10/padacas-drive-vs-logging-may-cost-her-gubernatorial-race
- R6. US State Dept — International Women of Courage (2007 honoree list): https://2009-2017.state.gov/s/ocr/woc/ (Wikipedia's original ABS-CBN conferral link is dead)

**Elections & annulment**
- R17. Philstar — "Comelec unseats Padaca" (Dec 9, 2009): https://www.philstar.com/nation/2009/12/09/530300/comelec-unseats-padaca
- R18. ABS-CBN (Santos) — "Comelec annuls Padaca's 2007 poll win in Isabela" (Dec 2009): https://www.abs-cbn.com/nation/12/08/09/comelec-annuls-padacas-2007-poll-win-isabela
- R19. Manila Times (archived) — "Grace Padaca loses in Isabela gubernatorial race" (2012): https://web.archive.org/web/20120609145952/http://www.manilatimes.net/index.php/news/regions/17381-grace-padaca-loses-in-isabela-gubernatorial-race
- R26. Rappler — "Incumbent clans dominate northern Luzon polls" (May 14, 2016): https://www.rappler.com/philippines/elections/133007-political-clans-dominate-north-luzon-polls/

**Corruption case**
- R8. Rappler (Lian Buan) — "Grace Padaca found guilty of corruption, ordered to return ₱18M" (Nov 2019): https://www.rappler.com/philippines/245043-grace-padaca-found-guilty-corruption
- R9a. Philstar — "Padaca's conviction for malversation upheld" (Sep 1, 2020): https://www.philstar.com/nation/2020/09/01/2039193/padacas-conviction-malversation-upheld
- R9b. Philstar — "Padaca gets 24 years for malversation, graft" (Nov 16, 2019): https://www.philstar.com/nation/2019/11/16/1969163/padaca-gets-24-years-malversation-graft/amp
- R20. Supreme Court e-library — Ombudsman resolution, G.R. No. 201800 (Padaca): https://elibrary.judiciary.gov.ph/thebookshelf/showdocs/1/64550
- R21. Rappler — "SC affirms corruption trial of Grace Padaca at Sandiganbayan" (2018): https://www.rappler.com/philippines/215577-sc-affirms-grace-padaca-corruption-trial-sandiganbayan
- R22. Inquirer — "Padaca found guilty of graft: 'I'm no thief'" (Nov 16, 2019): https://newsinfo.inquirer.net/1190501/padaca-found-guilty-of-graft-im-no-thief
- R22b. Inquirer — "Sandiganbayan finds Grace Padaca guilty of graft, malversation": https://newsinfo.inquirer.net/1190272/sandiganbayan-finds-grace-padaca-guilty-of-graft-malversation
- R23. CNN Philippines (archived) — "Sandiganbayan overturns graft conviction vs. ex-Isabela governor Padaca" (Nov 16, 2020): https://web.archive.org/web/20230626232339/https://www.cnnphilippines.com/news/2020/9/20/Sandiganbayan-overturns-graft-Isabela-governor-Grace-Padaca.html
- R24. Rappler — "Ex-Isabela governor Grace Padaca fined ₱4,000 for not filing SALNs" (Oct 10, 2017): https://www.rappler.com/philippines/184844-grace-padaca-fined-not-filing-saln/
- R25. Inquirer — "Losing LP's grace? Padaca scores Roxas for allying with rivals" (Nov 26, 2015): https://newsinfo.inquirer.net/742761/losing-lps-grace-padaca-scores-roxas-for-allying-with-rivals
- R27. GMA News — "Supreme Court affirms indictment, trial of Grace Padaca": https://www.gmanetwork.com/news/topstories/regions/673069/supreme-court-affirms-indictment-trial-of-grace-padaca/story

**Comelec appointment**
- R10. Rappler — "Grace Padaca new Comelec commissioner" (Oct 2012): https://www.rappler.com/philippines/13467-grace-padaca-new-comelec-commissioner
- R11. GMA News — "Former Isabela governor Padaca appointed Comelec commissioner": https://www.gmanetwork.com/news/topstories/nation/276461/former-isabela-governor-padaca-appointed-comelec-commissioner/story

**Cross-links to project data**
- R14. Philstar — "Isabela execs to pay radio station ₱5M" (Bombo Radyo dzNC shutdown; SC 2010): https://www.philstar.com/nation/2010/08/06/599713/isabela-execs-pay-radio-station-p5-million
